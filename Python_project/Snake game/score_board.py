...
class Score_Board(Turtle):
        def __init__(self):
                ...
                with open('/Users/nawinptkb/OneDrive - KMITL/KMITL-NIDA/Financial Engineering Freshmen/Semester 1/Intro To Programming/Github/nawinptkb/Python_project/Snake game/score_data.txt', mode='r') as score_data:
        ...
        def reset_scoreboard(self):
                if self.score > self.high_score:
                        ...
                        with open('/Users/nawinptkb/OneDrive - KMITL/KMITL-NIDA/Financial Engineering Freshmen/Semester 1/Intro To Programming/Github/nawinptkb/Python_project/Snake game/score_data.txt',mode='w') as score_data:
